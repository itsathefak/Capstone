...
export default function AboutPage() {
  const teamMembers = [
    ...
    { name: "Athef Ayub Khan", role: "Full Stack Developer", avatar: "AAK" },
    { name: "Anetia Faber", role: "Full Stack Developer", avatar: "AF" },
    { name: "Daksh Pathak", role: "Full Stack Developer", avatar: "DP" },
  ];
  ...
  return (
    <div className="about-min-h-screen about-bg-gradient">
      <Helmet>
        ...
        <meta
          name="description"
          content="Get to know more about our company's vision and our team members."
        />
            ...
            <div className="about-grid">
              <div className="about-card">
                ...
                <p className="about-card-description">
                  AppointMe bridges the gap between service providers and
                  clients, creating a frictionless booking experience that saves
              ...
              <div className="about-card">
                ...
                <p className="about-card-description">
                  We empower professionals with cutting-edge tools to manage
                  their schedules, showcase their services, and grow their
              ...
              {teamMembers.map((member, index) => (
                <div key={index} className="about-card about-card-team">
                  <div className="about-avatar">
                    <span className="about-avatar-fallback">
                      {member.avatar}
                    </span>
                  </div>
